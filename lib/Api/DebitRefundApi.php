...
class DebitRefundApi
{
    ...
    /**
     * Operation deleteanbillofitemtype
     *
     ...
     * @return void
     */
    public function deleteanbillofitemtype($x_myobapi_key, $company_file_id, $guid, $x_myobapi_version = 'v2', $accept_encoding = 'gzip,deflate', $delete_debit_refund = null)
    {
        $this->deleteanbillofitemtypeWithHttpInfo($x_myobapi_key, $company_file_id, $guid, $x_myobapi_version, $accept_encoding, $delete_debit_refund);
    }

    /**
     * Operation deleteanbillofitemtypeWithHttpInfo
     *
     * Delete a debit refund
     *
     * @param  string $x_myobapi_key The API key registered in https://my.myob.com.au/au/bd/DevAppList.aspx (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteanbillofitemtypeWithHttpInfo($x_myobapi_key, $company_file_id, $guid, $x_myobapi_version = 'v2', $accept_encoding = 'gzip,deflate', $delete_debit_refund = null)
    {
        $request = $this->deleteanbillofitemtypeRequest($x_myobapi_key, $company_file_id, $guid, $x_myobapi_version, $accept_encoding, $delete_debit_refund);
    ...
    /**
     * Operation deleteanbillofitemtypeAsync
     *
     * Delete a debit refund
     *
     * @param  string $x_myobapi_key The API key registered in https://my.myob.com.au/au/bd/DevAppList.aspx (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteanbillofitemtypeAsync($x_myobapi_key, $company_file_id, $guid, $x_myobapi_version = 'v2', $accept_encoding = 'gzip,deflate', $delete_debit_refund = null)
    {
        return $this->deleteanbillofitemtypeAsyncWithHttpInfo($x_myobapi_key, $company_file_id, $guid, $x_myobapi_version, $accept_encoding, $delete_debit_refund)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteanbillofitemtypeAsyncWithHttpInfo
     *
     * Delete a debit refund
     *
     * @param  string $x_myobapi_key The API key registered in https://my.myob.com.au/au/bd/DevAppList.aspx (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteanbillofitemtypeAsyncWithHttpInfo($x_myobapi_key, $company_file_id, $guid, $x_myobapi_version = 'v2', $accept_encoding = 'gzip,deflate', $delete_debit_refund = null)
    {
        $returnType = '';
        $request = $this->deleteanbillofitemtypeRequest($x_myobapi_key, $company_file_id, $guid, $x_myobapi_version, $accept_encoding, $delete_debit_refund);
    ...
    /**
     * Create request for operation 'deleteanbillofitemtype'
     *
     * @param  string $x_myobapi_key The API key registered in https://my.myob.com.au/au/bd/DevAppList.aspx (required)
     * @param  string $company_file_id The ID of the company in use (required)
     * @param  string $guid The GUID of the resource being created (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteanbillofitemtypeRequest($x_myobapi_key, $company_file_id, $guid, $x_myobapi_version = 'v2', $accept_encoding = 'gzip,deflate', $delete_debit_refund = null)
    {
        // verify the required parameter 'x_myobapi_key' is set
        if ($x_myobapi_key === null || (is_array($x_myobapi_key) && count($x_myobapi_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_myobapi_key when calling deleteanbillofitemtype'
            );
        }
        // verify the required parameter 'company_file_id' is set
        if ($company_file_id === null || (is_array($company_file_id) && count($company_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_file_id when calling deleteanbillofitemtype'
            );
        }
        // verify the required parameter 'guid' is set
        if ($guid === null || (is_array($guid) && count($guid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $guid when calling deleteanbillofitemtype'
            );
        }
